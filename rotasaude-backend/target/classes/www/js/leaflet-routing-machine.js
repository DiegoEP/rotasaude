	...
	L.Routing.Localization = {
		'en': {
			...
			instructions: {
				...
				'Head':
					['Siga na direção {dir}', ' na {road}'],
				'Continue':
					['Continue na direção {dir}', ' na {road}'],
				'SlightRight':
					['Curva suave à direita', ' na {road}'],
				'Right':
					['Vire à direita', ' em {road}'],
				'SharpRight':
					['Curva acentuada à direita', ' na {road}'],
				'TurnAround':
					['Meia volta'],
				'SharpLeft':
					['Curva suave à esquerda', ' na {road}'],
				'Left':
					['Vire à esquerda', ' na {road}'],
				'SlightLeft':
					['Curva acentuada à esquerda', ' na {road}'],
				'WaypointReached':
					['Ponto de chegada atingido'],
				'Roundabout':
					['Pegue a {exitStr} saída'],
				'DestinationReached':
					['Destino atingido'],
			},
